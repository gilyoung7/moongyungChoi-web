...
const I18N = {
    en: {
        /* ----- 문서 정보 ----- */
        "meta.title.index": "NANNAMUN — Seoul",
        "meta.desc.index": "A luxury fashion brand founded in 2025 by designer Moongyung Choi. Discover the NANNAMUN collection.",
        "meta.desc.category": "The NANNAMUN collection. Women, Men, Bags, Shoes, Accessories and Beauty.",
        "meta.title.error": "Page Not Found — NANNAMUN",
        ...
        "about.p3": "I've always wanted my brand \"NANNAMUN\", which started in 2025, to go global",
        "about.p4": "Now, enjoy my luxury brand NANNAMUN!",
        "about.imgAlt": "Signature look by designer Moongyung Choi",

        /* ----- 신상품 ----- */
        "new.title": "BEST COLLECTION",
        "new.item1": "NANNAMUN Signature Coat",
    ...
    ko: {
        /* ----- 문서 정보 ----- */
        "meta.title.index": "NANNAMUN — 서울",
        "meta.desc.index": "디자이너 최문경이 2025년 시작한 럭셔리 패션 브랜드. NANNAMUN의 컬렉션을 만나보세요.",
        "meta.desc.category": "NANNAMUN 컬렉션. 여성·남성 의류, 가방, 슈즈, 액세서리, 뷰티.",
        "meta.title.error": "페이지를 찾을 수 없습니다 — NANNAMUN",
        ...
        "about.p3": "2025년에 시작한 제 브랜드 \"NANNAMUN\"이 세계로 나아가기를 늘 바라왔습니다",
        "about.p4": "이제, 럭셔리 브랜드 NANNAMUN을 만나보세요",
        "about.imgAlt": "디자이너 최문경의 대표 착장",

        /* ----- 신상품 ----- */
        "new.title": "베스트 컬렉션",
        "new.item1": "NANNAMUN 시그니처 코트",
        "new.item2": "천연 가죽 가방",
        "new.item3": "긴 치마",
